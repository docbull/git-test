    ...
    (typeof self !== 'undefined' ? self : this, function () {
        var IPFSHlsMultiChunk=(()=>{
            ...
            var w=g((p,b)=>{
                ...
                async function loadVideoChunk(CID) {
                    return new Promise(resolve => {
                        const socket = new WebSocket('ws://203.247.240.228:3000');
                
                        socket.addEventListener('open', function (event) {
                            console.log('Web Socket Open');
                            socket.send('bafybeigwiw6ngj5aeqkim27xb5bpgg3pdpuk3xvwypqp3yotf6vun25jnu/master0.ts');
                        })    
                ...
                async function m(n,t,e,i,a){
                    ...
                    // let units = await loadVideoChunk(n);
                    let units = await loadChunk(n);
                    o.push(units);
                    l+=units.length;
                    if(a[0]){
